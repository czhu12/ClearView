...
export default async function handler(req, res) {
  if (req.method === "POST") {
    try {
      ...
      form.number_one = parseInt(req.body.number_one);
      if (req.body.number_two) form.number_two = parseInt(req.body.number_two);
      if (req.body.number_three) form.number_three = parseInt(req.body.number_three);
